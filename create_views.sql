...
create view jsscp_child_birth_view as (
    SELECT  individual.id "Ind.Id",
            ...
            single_select_coded(programEncounter.observations->>'7cecaf08-1a00-41a6-965b-015b89aa66ba')::TEXT as "Enc.Whether baby cleaned and dried immediately after birth",
            single_select_coded(programEncounter.observations->>'cdd45c89-b7be-4131-a6c0-48e8b82926c4')::TEXT as "Enc.Whether baby wrapped in warm clothes",
            single_select_coded(programEncounter.observations->>'734e9cd5-3df4-4cfd-bca4-aa842af2c84e')::TEXT as "Enc.Diagnosis of baby immediately after birth",
            single_select_coded(programEncounter.observations->>'426f1fbd-6211-47dc-9b58-05a94d8dd713')::TEXT as "Enc.Newborn cry",
            single_select_coded(programEncounter.observations->>'63495af0-0150-48a0-b52d-9656a8671f1b')::TEXT as "Enc.Newborn breathing",
            single_select_coded(programEncounter.observations->>'5b885356-ac8a-4e5c-bc6d-32ac05079d62')::TEXT as "Enc.Newborn movement",
            single_select_coded(programEncounter.observations->>'e2282953-329a-400f-aa12-7b1065a42f7a')::TEXT as "Enc.If baby was not breathing for 30 seconds, was any action taken",
            single_select_coded(programEncounter.observations->>'a11eea1e-4529-4bf1-a8b2-734e38a590bb')::TEXT as "Enc.Whether mucus extractor used",
            single_select_coded(programEncounter.observations->>'62fa4db7-448a-48fe-b5d4-5feb00752153')::TEXT as "Enc.What was the outcome of action",
            single_select_coded(programEncounter.observations->>'e4d30772-e360-4824-9acb-e417bb5b264e')::TEXT as "Enc.Newborn cried",
            single_select_coded(programEncounter.observations->>'f23c5d63-f73c-40e7-a4d0-9ebecf2a701c')::TEXT as "Enc.Newborn breath",
...
create view jsscp_abortion_followup_view as (
                                                 ...
                                                 SELECT
                                                     ...
                                                     single_select_coded(programEncounter.observations->>'7764a974-7ba8-4a13-9ba9-6d8d580f3c99')::TEXT as "Enc.Is there foul smelling discharge PV",
                                                     single_select_coded(programEncounter.observations->>'74c618b3-a4e0-4382-9486-70dbf5752d9d')::TEXT as "Enc.Does mother has seizures?",
                                                     single_select_coded(programEncounter.observations->>'43567d78-ad97-46bc-afa1-8522ec9e0180')::TEXT as "Enc.Does mother has any breast related issue like swelling etc?",
                                                     ...
                                                     (programEncounter.observations->>'e048675e-eb86-41c2-a47b-aecfa9a3bb8c')::TEXT as "Enc.Other referral reason",
                                                     single_select_coded(programEncounter.observations->>'0ac30adc-5107-4e30-9b8a-c3ef65904cf5')::TEXT as "Enc.Counselling",
                                                     single_select_coded(programEncounter.observations->>'dfe26772-b418-4741-a80b-30fcbe452b5f')::TEXT as "Enc.Family Planning Benefits for Women",
                                                     single_select_coded(programEncounter.observations->>'af57d463-f260-4a58-8b08-18f754d0a5e2')::TEXT as "Enc.The benefits of family planning to the child",
                                                     single_select_coded(programEncounter.observations->>'99593b34-a7f6-445f-aa59-7550f8c0f648')::TEXT as "Enc.Risks of not adopting family planning",
                                                     single_select_coded(programEncounter.observations->>'9aa87afd-8d1f-4870-9638-7a3b6aefa36d')::TEXT as "Enc.The exact time and interval of pregnancy",
                                                     single_select_coded(programEncounter.observations->>'2e5288f0-1f4b-4c72-bd6d-ae4fa072a1d9')::TEXT as "Enc.When is the possibility of next pregnancy after delivery?",
                                                     single_select_coded(programEncounter.observations->>'d833658b-ce1f-412d-bc34-086f8d1ba50d')::TEXT as "Enc.Have you thought about using any contraceptive",
                                                     single_select_coded(programEncounter.observations->>'1d7ed26e-17f8-4d27-b5e5-a0fc61336032')::TEXT as "Enc.If she had not thought about any contraceptive method",
                                                     single_select_coded(programEncounter.observations->>'35829406-7047-40a4-a970-17d029f49562')::TEXT as "Enc.Provide detailed information about the chosen contraceptive",
                                                     single_select_coded(programEncounter.observations->>'65cf7297-98ff-4405-b1df-336325f4d96e')::TEXT as "Enc.Repeat key points once again",
                                                     single_select_coded(programEncounter.observations->>'3eeb5be5-a74b-4cf4-805f-3b8549a5daef')::TEXT as "Enc.Give information about misconception of contraceptiv method",
                                                     single_select_coded(programEncounter.observations->>'48b372a3-b491-4c45-8d14-b99e5515daf2')::TEXT as "Enc.Motivate men to adopt contraceptive method",
                                                     single_select_coded(programEncounter.observations->>'338bf574-680c-4d8b-94f9-aa2b768dadeb')::TEXT as "Enc.refer mother to subcenter or ask SHW to see sepsis sign",
                                                     single_select_coded(programEncounter.observations->>'ca2af807-ec9f-4b33-8ffa-e17075979996')::TEXT as "Enc.refer the woman to SC or ask the SHW to make a home visit",
                                                     single_select_coded(programEncounter.observations->>'c3f8600a-aebf-44ea-967e-ff93c11a5946')::TEXT as "Enc.refer the mother to SC/Ganiyari",
                                                     single_select_coded(programEncounter.observations->>'1ade5184-6907-4187-9186-abd12caacf05')::TEXT as "Enc.Womane want to use any family plannig",
                                                     programEncounter.cancel_date_time "EncCancel.cancel_date_time",
                                                     single_select_coded(programEncounter.observations->>'bf400e7f-8e1b-4052-af49-b0db47b3eb5a')::TEXT as "EncCancel.Visit cancel reason",
                                                     (programEncounter.observations->>'d038a9c4-fe96-4c09-b883-c80691427b60')::TEXT as "EncCancel.Other reason for cancelling",
                                                     (programEncounter.observations->>'6e50431c-6cb0-495f-9735-dd431c9970ff')::DATE as "EncCancel.Date of next ANC Visit"
